...
const attachmentOptions = [
  ...
  { icon: MapPin, label: 'Location', type: 'location', color: 'bg-chat-online', description: 'Share location' },
  { icon: Package, label: 'Product', type: 'product', color: 'bg-primary', description: 'Share a product' },
  { icon: Tag, label: 'Offer', type: 'offer', color: 'bg-secondary', description: 'Send an offer' },
];
...
export function ChatInput({ 
  ...
  return (
    <div className="bg-background border-t safe-area-bottom">
      {/* Attachment Picker */}
      {showAttachments && (
        <div className="animate-slide-up bg-accent/50 border-b">
          ...
          <div className="flex-1 flex items-center gap-3">
            ...
            <div className="flex-1 flex items-center gap-0.5">
              {Array.from({ length: 30 }).map((_, i) => (
                <div
                  key={i}
                  className="w-1 bg-destructive/60 rounded-full waveform-bar"
                  style={{ 
        ...
        <div className="flex items-end gap-2 p-2">
          ...
          {message.trim() ? (
            <Button
              onClick={handleSend}
              size="icon"
              className="flex-shrink-0 w-12 h-12 rounded-full bg-secondary hover:bg-secondary/90 shadow-lg animate-bounce-in"
              disabled={disabled}
            >
            ...
            <Button
              ...
              size="icon"
              className="flex-shrink-0 w-12 h-12 rounded-full bg-secondary hover:bg-secondary/90 shadow-lg"
              disabled={disabled}
            >
