...
export function ChatList({ 
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      {/* Header */}
      <div className="px-4 py-3 flex items-center justify-between border-b bg-background safe-area-top">
        <div>
      ...
      <div className="px-4 py-3 bg-background">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 h-11 bg-accent border-0 rounded-xl text-sm placeholder:text-muted-foreground/60 focus-visible:ring-2 focus-visible:ring-primary/30"
          />
        </div>
      </div>
...
function ConversationItem({ conversation, isSelected, onClick }: ConversationItemProps) {
  ...
  const getTypeBadge = () => {
    switch (conversation.type) {
      case 'order': return { label: 'Order', color: 'bg-primary/20 text-primary' };
      case 'rfq': return { label: 'RFQ', color: 'bg-secondary/20 text-secondary' };
      case 'support': return { label: 'Support', color: 'bg-role-admin/20 text-role-admin' };
      default: return null;
    }
  };
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "active:scale-[0.98] touch-highlight",
        isSelected 
    ...
    >
      ...
      <div className="relative flex-shrink-0">
        ...
        {isOnline && (
          <div className="absolute bottom-0.5 right-0.5 w-3.5 h-3.5 bg-chat-online rounded-full border-2 border-background" />
        )}
        {isVerified && (
          <div className="absolute -top-0.5 -right-0.5 w-5 h-5 bg-primary rounded-full border-2 border-background flex items-center justify-center">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-2">
          ...
          <span className={cn(
            ...
            hasUnread ? "text-secondary font-bold" : "text-muted-foreground"
          )}>
        ...
        <div className="flex items-center justify-between gap-2 mt-1">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            {hasUnread && (
              <Badge className="bg-secondary text-secondary-foreground text-[10px] px-1.5 py-0 min-w-[20px] h-5 flex items-center justify-center rounded-full font-bold shadow-sm">
