...
import { ConfirmModal } from '@/components/referral/ConfirmModal';
...
export function Sidebar({ activeTab, onTabChange }: SidebarProps) {
  ...
  const userTier = 'Gold'; // Default tier for display
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">{userTier} Agent</p>
                </div>
