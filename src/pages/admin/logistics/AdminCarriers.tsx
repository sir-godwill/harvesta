...
const typeColors = {
  ...
  rail: 'bg-accent/10 text-accent-foreground',
};
    ...
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          ...
          { label: 'Total Shipments', value: carriers.reduce((a, c) => a + c.totalShipments, 0).toLocaleString(), color: 'text-accent-foreground' },
        ].map((stat) => (
          <Card key={stat.label}>
