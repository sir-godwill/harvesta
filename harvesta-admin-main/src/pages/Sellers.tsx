...
import { fetchSellers, Seller } from '@/lib/api';
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <StatCard title="Active" value={stats.active} icon={CheckCircle2} color="bg-success" />
        <StatCard title="Pending" value={stats.pending} icon={Clock} color="bg-warning" />
        <StatCard title="Suspended" value={stats.suspended} icon={XCircle} color="bg-destructive" />
      </div>
