...
const quickLinks = [
  ...
  { title: 'Become a supplier', link: '/become-supplier' },
      ...
      <section className="bg-gradient-to-br from-primary/10 via-background to-secondary/10 py-16 lg:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
            Find answers, get support, and learn how to make the most of Harvestá.
          </p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <Link to={cat.link} className="text-sm text-primary font-medium flex items-center gap-1 hover:underline">
      ...
      <section className="py-12 lg:py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card className="bg-card border-border text-center card-hover">
              <CardContent className="p-6">
