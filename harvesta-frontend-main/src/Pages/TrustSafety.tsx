...
const safetyFeatures = [
  {
    ...
    description: 'Multi-step verification including business registration, documentation, and quality checks.',
  },
  {
    icon: Lock,
  ...
  },
  {
    ...
    description: 'Continuous monitoring of supplier performance and product quality.',
  },
  {
    icon: CreditCard,
    title: 'Escrow Protection',
    description: 'Funds held securely until order confirmation for qualifying transactions.',
  },
  {
    icon: MessageSquare,
    title: 'Dispute Resolution',
    description: 'Fair and transparent process for resolving issues between buyers and suppliers.',
  },
  {
    icon: FileSearch,
    title: 'Fraud Detection',
    description: 'Advanced systems to detect and prevent fraudulent activities.',
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Your safety is our priority. Learn about the measures we take to ensure a 
              secure and trustworthy marketplace.
            </p>
            <div className="inline-flex items-center gap-3 bg-card border border-border rounded-full px-6 py-3">
              <ShieldCheck className="w-6 h-6 text-secondary" />
              <span className="font-semibold">Secure & Verified Marketplace</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Every supplier on Harvestá goes through a rigorous verification process 
                to ensure legitimacy and quality.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Business registration, licenses, and certifications</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold">Identity Confirmation</h4>
                    <p className="text-sm text-muted-foreground">Verification of key personnel and contact information</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Product sample review and quality standards check</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Continuous performance and review tracking</p>
                  </div>
                </li>
              </ul>
            </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-muted/50 rounded-lg">
                    ...
                    <span className="text-sm font-medium">Premium Supplier</span>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="max-w-2xl mx-auto bg-card border-border">
            <CardHeader className="text-center">
              ...
              <p className="text-muted-foreground mt-2">
                Help us maintain a safe marketplace by reporting suspicious activity.
              </p>
            </CardHeader>
            <CardContent>
              <div className="mb-6">
              ...
              <Button className="w-full" asChild>
                <Link to="/contact?subject=Report">Report an Issue</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="py-12 lg:py-16 bg-muted/30">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
            Review our comprehensive policies to understand your rights and protections.
          </p>
