        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex gap-8">
            ...
            <FilterSidebar
              ...
              className="hidden lg:block w-72 shrink-0 sticky top-24 h-fit"
            />
                  ...
                  <Sheet>
                    ...
                    <SheetContent side="left" className="w-80 p-0">
                      <FilterSidebar
                        ...
                        onFiltersChange={setFilters}
                        onClearFilters={clearFilters}
                        className="border-0 h-full overflow-auto"
                      />
                    </SheetContent>
                  </Sheet>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {filters.category && (
                    <Badge variant="secondary" className="gap-1">
                      {filters.category}
                      <button onClick={() => setFilters(prev => ({ ...prev, category: undefined }))}>×</button>
                    </Badge>
                  )}
                  {filters.grade?.map(g => (
