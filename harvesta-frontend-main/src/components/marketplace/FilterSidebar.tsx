...
export function FilterSidebar({ filters, onFiltersChange, onClearFilters, className }: FilterSidebarProps) {
  ...
  const activeFiltersCount = [
    ...
    filters.moqRange?.min || filters.moqRange?.max,
  ...
  return (
    <aside className={cn('bg-card rounded-xl border border-border p-4', className)}>
      ...
      <div className="space-y-2">
            ...
            {grades.map(grade => (
              <label key={grade} className="flex items-center gap-3 cursor-pointer">
                <Checkbox
                  ...
                  onCheckedChange={() => handleMultiSelectChange('grade', grade)}
                />
        ...
        <Collapsible open={expandedSections.includes('certifications')}>
          <CollapsibleTrigger 
            ...
            {certifications.map(cert => (
              <label key={cert} className="flex items-center gap-3 cursor-pointer">
                <Checkbox
                  ...
                  onCheckedChange={() => handleMultiSelectChange('certifications', cert)}
                />
