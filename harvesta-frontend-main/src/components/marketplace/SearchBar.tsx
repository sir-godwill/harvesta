  ...
  return (
    <div className={cn('relative w-full', className)}>
      <form onSubmit={handleSubmit} className="relative">
        <div className={cn(
          'relative flex items-center bg-card border-2 rounded-xl transition-all duration-200',
            ...
            <div className="p-2">
              {suggestions.map((suggestion, index) => (
                <button
                  ...
                  className="w-full px-4 py-2 text-left text-sm hover:bg-muted rounded-lg transition-colors flex items-center gap-3"
                >
